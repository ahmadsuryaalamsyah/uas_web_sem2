                ...
                <?php 
                   ...
                   ?>
                    <div class="col-lg-12">
                        <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                ...
                                <div class="trend-top-cap">
                                    <span><?php echo $name ?>, <?php echo $date ?></span>
                                    <h2><a href="details.php?data=<?php echo $article_id;?>"><?php echo $title ?></h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <?php 
                            $sql_k = "SELECT `name`, `title`, `cover`, DATE_FORMAT(`created_at`, '%d-%m-%Y') FROM `articles` 
                                      INNER JOIN `categories` ON `articles`.`category_id` = `categories`.`category_id` 
                                ...
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><a href="details.php?data=<?php echo $article_id;?>"><?php echo htmlspecialchars($title); ?></a></h4>
                                        </div>
                                    </div>
                                </div>
                            <?php 
                        ...
                        ?>
                            <div class="col-lg-4">
                                <div class="single-bottom mb-35">
                                    ...
                                    <div class="trend-bottom-cap">
                                        <span class="color1"><?php echo htmlspecialchars($name); ?>, <?php echo htmlspecialchars($date); ?></span>
                                        <h5><a href="details.php?data=<?php echo $article_id;?>"><?php echo htmlspecialchars($title); ?></a></h5>
                                    </div>
                                </div>
                            </div>
                        <?php 
