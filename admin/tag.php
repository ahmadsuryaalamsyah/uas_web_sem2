            ...
            <div class="card">
              ...
              <?php if(!empty($_GET['notif'])){?>
                  <?php if($_GET['notif']=="tambahberhasil"){?>
                    ...
                    <?php }else if($_GET['notif']=="editberhasil"){?><div class="alert alert-success" role="alert"> Data Berhasil Diubah</div>
                    <?php }else if($_GET['notif']=="hapusberhasil"){?><div class="alert alert-success" role="alert"> Data Berhasil Dihapus</div>
                       <?php }?>
                  <?php }?>
              </div>
                       ...
                       if (isset($_GET["katakunci"])){
                        $katakunci_kategori = $_GET["katakunci"];
                           if($halaman!=1){
                              ...
                              <a class='page-link' href='tag.php?katakunci=$katakunci_kategori&halaman=1'>First</a></li>";
                              echo "<li class='page-item'><a class='page-link' href='tag.php?katakunci=$katakunci_kategori&halaman=$sebelum'>«</a></li>";
                           }
                           for($i=1; $i<=$jum_halaman; $i++){
                            if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                               if($i!=$halaman){
                                echo "<li class='page-item'><a class='page-link' href='tag.php?katakunci=$katakunci_kategori&halaman=$i'>$i</a></li>";
                               }else{
                                  echo "<li class='page-item'>
                            ...
                            if($halaman!=$jum_halaman){
                               echo "<li class='page-item'>
                               <a class='page-link' href='tag.php?katakunci=$katakunci_kategori&halaman=$setelah'>»</a></li>";
                               echo "<li class='page-item'><a class='page-link' href='tag.php?katakunci=$katakunci_kategori&halaman=$jum_halaman'>Last</a></li>";
                            }
                        }else{
                          if($halaman!=1){
