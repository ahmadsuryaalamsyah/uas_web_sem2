             ...
             <div class="card">
               ...
               <table class="table table-bordered">
                     ...
                     if (isset($_GET["katakunci"])) {
                       ...
                       $sql_b .= " WHERE `b`.`Judul` LIKE '%$katakunci_kategori%' OR `k`.`kategori_blog` LIKE '%$katakunci_kategori%'";
                   }                 
               ...
               <div class="card-footer clearfix">
                 ...
                 <a class='page-link' href='blog.php?halaman=1'>First</a></li>";
                 echo "<li class='page-item'>
                 <a class='page-link' href='blog.php?halaman=$sebelum'>«</a></li>";
                  }
                for($i=1; $i<=$jum_halaman; $i++){
                  if($i!=$halaman){
                     echo "<li class='page-item'>
                     <a class='page-link' href='blog.php?halaman=$i'>$i</a></li>";
                  }else{
                      echo "<li class='page-item'>
                 ...
                 if($halaman!=$jum_halaman){
                      echo "<li class='page-item'>
                      <a class='page-link' href='blog.php?halaman=$setelah'>»</a></li>";
                      echo "<li class='page-item'>
                      <a class='page-link' href='blog.php?halaman=$jum_halaman'>Last</a></li>";
                 }
               }
               ?>
                 </ul>
